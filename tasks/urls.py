...
urlpatterns = [
  ...
  path('tasks/<str:pk>', TaskDetailView.as_view(), name='task-detail'), # Retrieve, update, and delete a Task
  path('tasks/<str:pk>/status', TaskStatusUpdateView.as_view(), name='task-status-update'), # Update Todo status
]
